...
export function Home({ openAbout: shouldOpen = false }: { openAbout?: boolean }) {
  ...
  return (
    <>
      <PageMeta
        title={undefined}
        description={`${site.name}. ${site.descriptor}. ${site.statement}`}
      />
        ...
        <div className="page">
          <div className="home-opening__grid">
            ...
            >
              ...
              <p className="lead home-opening__standfirst">{about.standfirst}</p>
            ...
            >
              <Figure image={about.portraitFormal} priority showCaption={false} seed="formal" />
      ...
      <section className="home-record room" aria-labelledby="home-record-title">
        <div className="page">
          <Reveal>
            <div className="home-record__grid">
              ...
              <div className="home-record__facts">
                ...
                <p className="home-record__body">
                  One of these pictures is the one that goes on an application. The other
                  is the one that explains the work. Both are placeholders until you
                  replace them.
                </p>
          ...
          <div className="demo-note home-record__demo">
            ...
            <span>
              Both portraits, and every line of text on this page, are placeholders.
